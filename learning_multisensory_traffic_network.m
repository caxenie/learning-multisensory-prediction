%% Learning Multisensory Fusion for Traffic Prediction
%% PREPARE ENVIRONMENT
        ...
        if(DYN_VISUAL==1)
            if traffic_demo == 1
                ...
                switch traffic_pair
                    case 1
                        % example NO2 and Humidity for site 1
                        visualize_runtime_traffic_setup(uon_sensory_data, sensory_data, populations, didx, 'NO2', 'Humidity');
                    case 2
                        % example NO2 and Vehicle Count for site 1
                        visualize_runtime_traffic_setup(uon_sensory_data,sensory_data, populations, didx, 'NO2', 'VehicleCount');
                    case 3
                        % example Humidity and Vehicle Count for site 1
                        visualize_runtime_traffic_setup(uon_sensory_data,sensory_data, populations, didx, 'Humidity','VehicleCount');
                end
            end
        end
